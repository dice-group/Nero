...
str_description_logic='Brother'
expr = parser.parse_expression(str_description_logic)
sparql = converter.as_query("?x", expr, False)

print(sparql)
"""
SELECT ?s ?p ?o
{ 
  ?s <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.benchmark.org/family#Brother>
}
"""